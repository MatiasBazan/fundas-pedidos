...
<div class="grid grid-cols-2 gap-4 mb-5">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 sm:p-5 flex items-center gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-10 sm:h-10 bg-[#FFD6E5] rounded-xl flex items-center justify-center flex-shrink-0">
            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-[#FF2D6B]" fill="currentColor" viewBox="0 0 20 20">
                <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3z"/>
            </svg>
        </div>
        <div class="min-w-0">
            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Uds. totales</p>
            <p class="text-base sm:text-xl font-bold text-gray-900 truncate">{{ number_format($totalUnidades) }}</p>
        </div>
    </div>
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 sm:p-5 flex items-center gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-10 sm:h-10 bg-[#FFD6E5] rounded-xl flex items-center justify-center flex-shrink-0">
        ...
        <div class="min-w-0">
            ...
            <p class="text-base sm:text-xl font-bold text-gray-900 truncate">${{ number_format($totalInvertido, 2, ',', '.') }}</p>
        </div>
    </div>
</div>
