...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-500 mt-0.5">{{ $pedido->nombre_disenio }}</p>
</div>
    ...
    <form method="POST" action="{{ route('pedidos.update', $pedido) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <select name="stock_id"
                        ...
                        @foreach($stockDisponible as $stock)
                            <option value="{{ $stock->id }}" {{ old('stock_id', $pedido->stock_id) == $stock->id ? 'selected' : '' }}>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-600 mb-1.5">Precio ($)</label>
                    <div class="relative">
