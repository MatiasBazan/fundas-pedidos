...
@section('content')
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mt-2">Editar Pedido #{{ $pedido->id }}</h1>
        <p class="text-gray-600 mt-1">Modifica los datos del pedido</p>
    </div>

    <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow max-w-3xl mx-auto">
        <!-- Header del formulario -->
        <div class="bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200 px-8 py-6 rounded-t-xl">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Pedido #{{ $pedido->id }} - {{ $pedido->nombre_disenio }}</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('pedidos.update', $pedido) }}" class="p-8">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="mt-3 w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all">
                            @error('marca_id')
            ...
            <div class="mt-8 flex gap-3 pt-6 border-t-2 border-gray-100">
                <button type="submit"
                        class="flex-1 md:flex-none bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-3.5 rounded-xl text-sm font-bold transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
